...
frnzer.on('chat-update', async (frnazer) => {
		try {
			...
			const ownerNumber = ["62895333288886@s.whatsapp.net"] // Nomor Owner Bre
			const ownerContact = ["62895333288886;","6283172490882"] // Nomor Owner Bre Yg Bentuk Kode Jangan Di Ganti
...
frnzer.sendButton(from,ucapanWaktu,'Creator: ARIL BOTZ','NEXT➡',`${prefix}doge`,{quoted: faketroli})
break	                
